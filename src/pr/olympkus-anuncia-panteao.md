---
title: Olympkus AI anuncia o Panteão: suíte de agentes de IA para a vida pessoal
...
"A mensagem que mais nos diferencia não é 'agente que age por você' — isso outros já dizem. É um agente por domínio, orquestrados por um comando único", afirma a empresa. "A autonomia isolada já está sendo comoditizada. A arquitetura do Panteão é o que nenhum concorrente consegue replicar, porque nenhum tem os três produtos."

O modelo da Olympkus se diferencia pela abordagem de controle: "você aprova, o agente executa". Nenhum agente executa uma ação significativa sem a aprovação do usuário, que define os limites de autonomia para cada categoria.

## Lista de espera

A lista de espera para o Pluto está aberta. Os primeiros da fila entram como membros fundadores, com condições especiais no lançamento. O acesso é por convite — cada indicação sobe a posição do usuário na fila.
...
---
*Nota: todas as datas de lançamento são previstas e podem ser ajustadas. Os claims sobre funcionalidades dos agentes estão sujeitos a revisão jurídica antes do lançamento.*
